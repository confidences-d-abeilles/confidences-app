    ...
    return (
      <div className="card mb-4 bg-light">
        ...
        <div className="card-body p-2">
          ...
          <label>
Mention :
            <input type="text" className="form-control" name="mention" value={this.state.mention} onChange={handleChange.bind(this)} />
          </label>
          <label>
Model :
            <input type="text" className="form-control" name="model" value={this.state.model} onChange={handleChange.bind(this)} />
          </label>
