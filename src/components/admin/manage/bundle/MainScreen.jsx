        ...
        <div className="col">
          ...
          <div className="row my-2">
            ...
            <div className="col-2 my-2">
              <label htmlFor="p">
                <input type="checkbox" name="p" id="p" checked={this.state.p} onChange={this.handleFilter} />
                {' '}
Particuliers
              </label>
&nbsp;&nbsp;
              <label htmlFor="e">
                <input type="checkbox" name="e" id="e" checked={this.state.e} onChange={this.handleFilter} />
                {' '}
Entreprises
              </label>
&nbsp;&nbsp;
