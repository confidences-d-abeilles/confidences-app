...
%)
                ...
                <div className="card mt-4">
                  ...
                  && (
                  <a href={`${config.cdn_url}/${this.state.bundle.certif}`} target="_blank" className="btn btn-secondary btn-sm my-2">
Actuel
                    ...
                    <div className="form-group">
                      <label htmlFor="certif" className={(this.state.certif) ? 'active-upload' : 'upload'} style={{ position: 'relative' }}>
                        ...
                        />
                      Glisser un PDF ou cliquez pour en séléctionner un parmi vos fichiers
                        <br />
