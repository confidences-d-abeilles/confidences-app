          ...
          {!this.state.redirect ? (
            <div className="col-lg-6 col-md-10 col-sm-12">
              ...
              <p className="align-middle">
                            ...
                            tout autre fichier que vous jugeriez utile.
                <br />
                <i>
Ce service n’est pas inclus dans l’offre de
                ...
                <div className="form-group">
                  ...
                  <label htmlFor="attachment" className={(this.state.attachment) ? 'active-upload' : 'upload'} style={{ position: 'relative' }}>
                    <input
                      ...
                      id="attachment"
                      onChange={() => { this.setState({ attachment: document.getElementById('attachment').files[0].name }); }}
                      style={{
                        position: 'absolute', height: '5.5em', top: '0', left: '0', opacity: '0.0001',
                      }}
                    />
                              Glissez votre fichier ici ou cliquez pour en séléctionner un parmi vos fichiers. (Taille limitée à 5Mo.)
                    <br />
