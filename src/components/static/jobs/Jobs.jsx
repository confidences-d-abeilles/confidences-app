        ...
        <div className="row mt-4 justify-content-center align-items-center">
          <div className="col-lg-9 col-md-10 col-sm-12">
            <h1 className="text-center my-4">
              ...
              <img
                src={require('../../../assets/img/smiley/in-love.svg')}
                alt="smiley in love"
                style={{ height: '1em' }}
              />
            </h1>
            <p>
              ...
              collaborateurs ;
              {' '}
              <strong>des collaboratrices à 98%</strong>
              {' '}
même !
              Oui, vous avez bien lu ! Et au niveau du management cela se passe
              comment ? En fait, il faut savoir qu’une ruche c’est
              {' '}
              <strong>50 000 ouvrières</strong>
              {' '}
qui
              travaillent de concert pour servir leur reine mère.
              <br />
              <span className="align-middle">Ceci explique donc cela&nbsp; </span>
              <img
                src={require('../../../assets/img/smiley/nerd.svg')}
                alt="smiley nerd"
                style={{ height: '1em' }}
              />
            </p>
            <p>
              ...
              des talents à revendre ? Rejoindre
              {' '}
              <strong>
une jeune équipe, dynamique et
              passionnée
              </strong>
              {' '}
par son travail vous tente ? Alors n’hésitez plus, nous avons
              des challenges et des missions à la hauteur de
              {' '}
              <strong>vos ambitions</strong>
              {' '}
!
...
,
                  {' '}
                  <strong>Community | Event Management</strong>
                  {' '}
ou encore en
                  {' '}
                  <strong>
Systèmes
                  ...
                  {' '}
nous sommes intéressés. Retrouvez nos offres de stage de 4 à 6 mois.
