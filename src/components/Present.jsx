        ...
        <div className="row">
          <div className="col">
            <p className="">
              ...
              {' '}
              <strong>
nous vous invitons à lire toutes
                  ces étapes avant de commencer.
              </strong>
            </p>
            <ol className="lead">
              <li className="my-4">
              ...
              <li className="my-4">
                  ...
                  laquelle doit être notifié le bénéficiaire.
                <br />
                <strong>Un délai de 3 jours est recommandé.</strong>
              </li>
              <li className="my-4">
        ...
        <div className="row">
          <div className="col">
            <p className="text-center">
              <Link to="/signup/individual" className="btn btn-secondary">
J'offre un parrainage
                <br />
d’abeilles
              </Link>
            </p>
