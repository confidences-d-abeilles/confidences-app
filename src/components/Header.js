...
export default class Header extends Component {
  constructor(props) {
    ...
    this.state = {
      redirect: false,
      banner: !(localStorage.getItem('hide')),
      email: '',
      firstname: '',
      newsletter: false,
    };
  ...
  render() {
    return (
      <div>
        ...
        && (
        <div style={{
          width: '100%', height: 'auto', backgroundColor: '#424242', color: 'white', lineHeight: '3em', textAlign: 'center',
        }}
        >
          &nbsp;&nbsp;Ceci est la première version de la plateforme. Si vous rencontrez des difficultés au cours de son utilisation,
          {' '}
          <Link to="/contact">contactez nous</Link>
          {' '}
!
          {' '}
          <button className="btn btn-link" onClick={() => { this.setState({ banner: false }); this.hide(); }}>Fermer</button>
        </div>
        )}
        <nav className="navbar navbar-toggleable-md navbar-light" style={{ boxShadow: '0 2px 2px silver' }}>
          ...
          <Link className="navbar-brand" to="/">
            ...
            <h2
              ...
              style={{
                position: 'absolute', top: '75px', left: '75px', fontSize: '1.5em', zIndex: 1000,
              }}
            >
            ...
            {(isLoggedIn())
              ? (
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="https://confidencesdabeilles.fr/" target="_blank" rel="noopener noreferrer">
Boutique
                      <FontAwesome name="external-link" />
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="https://confidencesdabeilles.fr/blog" target="_blank" rel="noopener noreferrer">
Blog
                      <FontAwesome name="external-link" />
                    </a>
                  </li>
            ...
            : (
              <ul className="navbar-nav hidden-md-down">
                <li className="nav-item">
                  <NavLink
                    className="nav-link"
                    to="/company/presentation"
                    activeStyle={{
                      backgroundColor: 'rgb(230,230,230)',
                      boxShadow: '0px 0px 5px 2px rgb(230,230,230)',
                    }}
                  >
Entreprise
                  </NavLink>
              ...
              <ul className="navbar-nav ml-auto hidden-md-down">
                ...
                La société
                  ...
                  <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a className="dropdown-item" href="https://confidencesdabeilles.fr/" target="_blank" rel="noopener noreferrer">
Boutique
                      <FontAwesome name="external-link" />
                    </a>
                    <a className="dropdown-item" href="https://confidencesdabeilles.fr/blog" target="_blank" rel="noopener noreferrer">
Blog
                      <FontAwesome name="external-link" />
                    </a>
                  </div>
