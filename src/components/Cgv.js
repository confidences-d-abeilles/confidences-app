...
<br /><br />
L’offre de parrainage prend effet lorsque la commande est confirmée par Confidences d'Abeilles (se référer à l’Article – 6 Commande). La durée de l'engagement est de un an à date anniversaire et la reconduction n’est pas tacite.
</p>
<h3>Article 3 – Vendeur</h3>
<p>
...
Adresse électronique : contact@nomdedomaine.fr<br />
...
<br /><br />
Le prix ne comprend pas les frais d’expédition hors de France métropolitaine ainsi que dans les DOM-TOM. Ils sont facturés en supplément du prix des Produits achetés selon des modalités qui sont définies à posteriori et au cas par cas. Le Client reconnait en être pleinement conscient lors de l’achat d’un Produit.
<br /><br />
...
<br /><br />
Dès lors que le Client confirme sa commande en cliquant sur ''VALIDER ET PAYER'', il est considéré comme ayant accepté en connaissance de cause le contenu et les conditions de la commande ; en particulier les présentes Conditions Générales de Vente, les quantités et délais de livraison du Produit choisi.
<br /><br />
La vente sera définitive au moment de la confirmation de la commande par le Client.
Cette commande sera confirmée par Confidences d'Abeilles qui enverra un courrier électronique au Client reprenant l’ensemble des informations relatives à la commande ainsi qu'un lien vers le formulaire de rétractation.
<br /><br />
...
<br /><br />
Confidences d'Abeilles recommande au Client de conserver les courriers électroniques reçus. Le Client est informé que les trois courriers électroniques seront adressés à l'adresse de messagerie électronique saisie par le Client au moment de son identification, préalablement à la finalisation de la commande. La responsabilité de Confidences d’Abeille ne saurait être engagée en cas d'erreur de saisie de l'adresse de messagerie électronique concernée, ou de non réception du message électronique de confirmation de la commande.
<br /><br />
...
Pour un achat ou plus exactement la souscription ou le renouvellement d’un Parrainage effectuée entre le 1er juillet et le 31 décembre, la livraison a lieu à partir du mois de mai de l’année suivante.
...
<h3>Article 9 – Réclamations</h3>
<h4>Garanties Légales des Produits</h4>
<p>
...
<h3>Article 10 – Confidentialité et protection des données personnelle</h3>
<p>
...
Confidences d'Abeilles collecte et traite des données à caractère personnel concernant le Client et le destinataire de la commande (sauf n° de carte bancaire) sous forme informatisée aux seules fins de gestion des commandes. Le Client bénéficie, conformément à la loi du 6 janvier 1978, d'un droit d'accès, de rectification et d'opposition sur l'ensemble des données à caractère personnel le concernant qui s'exerce par email à l'adresse suivante : contact@nomdedomaine.fr ou par courrier à l’adresse suivante : Confidences d'Abeilles – Service Parrainage – 319 chemin des plantées, 74210 – Faverges – France
...
<h3>Article 11 – Modification des présentes Conditions Générales de Vente</h3>
<p>
...
<h3>Article 12 – Actualités et Configuration de la page dédiée</h3>
<p>
...
Le directeur de la publication du Site Internet est Gaëtan EKSZTEROWICZ en sa qualité de représentant légal de la société Confidences d'Abeilles SAS. Ladresse du webmaster est : contact[at]nomdedomaine.fr
