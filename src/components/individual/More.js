        ...
        <div className="row justify-content-center">
          ...
          <div className="col-9">
            ...
            <p>
              ...
              cadeau unique et exceptionnel de vos abeilles vous remerciant pour votre engagement.
              <br />
              <br />
              ...
              découvrir d’autres informations sur une page spécialement dédiée à cette ruche.
              <br />
              ...
              consulter l’état de votre parrainage
              <br />
              Une fois la récolte effectuée, le miel mis en pot et les étiquettes personnalisées collées
              nous vous expédierons le miel de vos abeilles ainsi qu’un certificat de parrainage !
              <br />
              <br />
              ...
              <em>
                {' '}
Il est possible
                <strong>d’offrir un parrainage d’abeilles</strong>
                {' '}
ou une ruche complète en
            ...
            <p>
              ...
              <ul>
                <li>
                  ...
                  printemps ; c’est-à- dire à dire à partir du mois de mai de l’année suivante.
                </li>
                <li>
            ...
            <p>
              <Link to="/prices">Consulter les tarifs</Link>
              <br />
              <br />
