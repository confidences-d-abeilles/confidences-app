			...
			<div className="container py-4">
				...
				<div className="row justify-content-center">
					<div className="col-6">
						...
						<p>
							Je parraine X abeilles d'une ruche sur laquelle sera marqué mon nom.
							Je recevrais 8*i pots de miel de 250g produit par mes abeilles.
						...
						<div className="row justify-content-center">
							...
							<div className="col-6">
								...
								<input type="checkbox" /> L'adresse de facturation est identique à celle de livraison
							</div>
						</div>
						...
						<p className="text-center">
							<Link to="/individual/end" className="btn btn-primary">Valider et payer</Link>
						</p>
					</div>
				</div>
			</div>
