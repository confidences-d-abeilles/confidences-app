		...
		if (this.state.user && this.state.user.bundles[0] && this.state.user.bundles[0].state === 0 ) {
			return (
                <div className="text-center">
                    <p className="alert alert-danger mt-4">Vous n'avez pas encore réglé votre parrainage. <Link to="/individual/checkout">Cliquez ici</Link> pour le faire ou<Link to="/individual/checkout">la pour modifier</Link>l'offre choisie</p>
