            ...
            <form className="text-center">
              ...
              <div className="form-group">
                <label className="form-check-label">
                  <input className="form-check-input" type="radio" name="how" value="1" checked={(this.state.how === '1')} onChange={handleChange.bind(this)} />
              ...
              <div className="form-group">
                <label className="form-check-label">
                  <input className="form-check-input" type="radio" name="how" value="2" checked={(this.state.how === '2')} disabled onChange={handleChange.bind(this)} />
