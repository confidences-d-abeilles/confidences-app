        ...
        <div className="row justify-content-center">
          <div className="col-lg-6 col-md-10 col-sm-12">
            <form className="text-center">
              ...
              <div className="form-group">
                <input
                  type={(this.state.user_type === 3) ? 'text' : 'tel'}
                  name={(this.state.user_type === 3) ? 'school' : 'phone'}
                  className="form-control"
                  placeholder={(this.state.user_type === 3) ? 'Ecole ou établissement' : 'Numéro de telephone *'}
