...
export default class CompanyManage extends Component {
	...
	checkInfos() {
		...
		if (this.state.user && this.state.user.newsletter) {
			return (
				<p className="alert alert-warning mt-4">Vous êtes maintenant inscrit(e) à la newsletter. Une fois tous les 2 mois vous recevrez des nouvelles de vos abeilles ainsi que des nôtres. Si vous ne souhaitez pas la recevoir, merci de modifier vos préférences.</p>
			)
		}
