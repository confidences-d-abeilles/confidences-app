        ...
        <div className="row py-4">
          ...
          <div className="col text-center">
            ...
            {(this.state.user && this.state.user.bundles[0] && this.state.user.bundles[0].certif && this.state.user.bundles[0].state > 1)
              ? (
                <a
                  href={`${config.cdn_url}/${this.state.user.bundles[0].certif}`}
...
Vous pouvez maintenant choisir le nom de
                            {this.state.user.bundles[0].hives > 1 ? 'vos ruches' : 'votre ruche'}
.
                          </p>
                        </div>
...
Ruche n°
                  ...
                  Notre offre:
                              {' '}
                              {this.state.user.bundles[0].hives}
                              {' '}
ruche
                              {this.state.user.bundles[0].hives > 1 ? 's' : ''}
                              <br />
                  Date de début:
                              {' '}
                              {moment(this.state.user.bundles[0].start_date).format('DD/MM/YYYY')}
                              <br />
                  Date de fin:
                              {' '}
                              {moment(this.state.user.bundles[0].end_date).format('DD/MM/YYYY')}
                              <br />
                            </p>
                          )
                          : null
