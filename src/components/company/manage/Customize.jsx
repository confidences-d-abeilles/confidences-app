                ...
                <div className="card">
                  <div className="card-block text-center">
                    <div>
                      ...
                      <i className="card-text" style={{ fontSize: '85%' }}>
Une version « par défaut » est générée automatiquement. 3
                      solutions sont à votre disposition pour la modifier.
                      </i>
              ...
              <div className="col text-center">
                <div className="card">
                  <div className="card-block">
                    ...
                    <p style={{ fontSize: '85%' }}>
Téléchargez un modèle (format AI, INDD),
            Modifiez-le,
            Renvoyez-nous votre version !
                    </p>
                    ...
                    <form onSubmit={this.upload.bind(this)} className="my-2">
                      <div className="form-group">
                        <div style={{ fontSize: '85%' }}>
                          <label htmlFor="label" className={(this.state.label) ? 'active-upload' : 'upload'}>
Glissez votre fichier ou cliquez pour en sélectionner un
                (formats acceptés : PDF, AI, INDD, PSD, PNG, JPG)
                            <br />
                ...
                perdu gauche/droite et 0,5mm haut/bas. -
                            {(this.state.label) ? `Selectionné : ${this.state.label}` : 'Aucun fichier séléctionné'}
                          </label>
                        </div>
              ...
              <div className="card-block text-center">
                <div className="row">
                  <div className="text-center col">
                    ...
                    <br />
                    <button className="btn btn-primary btn-sm">Bientôt disponible</button>
                    <br />
...
Ces templates sont proposés par Marine du Peloux.
              Vous avez une idée, vous voulez lui confier la
              réalisation de votre étiquette ? Contactez-la !
                    </p>
                    <br />
