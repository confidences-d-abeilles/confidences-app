...
Photo de couverture de votre page
                  {(this.state.cover) ? <a href={`${config.cdn_url}/${this.state.cover}`} target="_blank">Visualiser l'image actuelle</a> : null}
                </label>
              ...
              Glissez une
                  ...
                  {' '}
image ici ou cliquez pour en séléctionner une parmi vos fichiers
                  <br />
              Recommandations : 1140x320px, 160ko maximum -
                  {' '}
                  {(this.state.newCover) ? `Selectionné : ${this.state.newCover}` : 'Aucun fichier séléctionné'}
                </label>
              </div>
              <div className="form-group">
                <label>
Logo de votre entreprise
                  {(this.state.logo) ? <a href={`${config.cdn_url}/${this.state.logo}`} target="_blank">Visualiser le logo actuel</a> : null}
                </label>
              ...
              Glissez votre
                  ...
                  {' '}
logo ici ou cliquez pour en séléctionner un parmi vos fichiers
                  <br />
              Recommandations : 200x200px, 30ko maximum -
                  {' '}
                  {(this.state.newLogo) ? `Selectionné : ${this.state.newLogo}` : 'Aucun fichier séléctionné'}
                </label>
