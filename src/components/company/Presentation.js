          ...
          <div className="col-lg-6 col-md-10 hidden-sm-down my-4">
            <div id="carouselHome" className="carousel slide" data-interval="3000" data-ride="carousel">
              <ol className="carousel-indicators">
                ...
                <li data-target="#carouselHome" data-slide-to="3" />
                <li data-target="#carouselHome" data-slide-to="4" />
                <li data-target="#carouselHome" data-slide-to="5" />
                <li data-target="#carouselHome" data-slide-to="6" />
                <li data-target="#carouselHome" data-slide-to="7" />
              </ol>
        ...
        <div className="row justify-content-around align-items-start">
          <div className="col-lg-5 col-md-6 col-sm-10 card" style={{ backgroundColor: '#ECEFF1' }}>
            ...
            <ul>
              ...
              <li>
                S’engager concrètement dans la
                {' '}
                <strong>protection de la biodiversité</strong>
              </li>
              <li>
                Une stratégie pour
                {' '}
...
, original et engageant à publier régulièrement sur les
                {' '}
              ...
              <li>
                Une
                {' '}
                <strong>page, dédiée à l'entreprise</strong>
, détaille sa démarche environnementale ; des photos de sa ruche ainsi que des actualités y sont régulièrement postées
              ...
              <li>
                <strong>80 pots de miel de 125g personnalisés</strong>
                {' '}
aux couleurs de l’entreprise : un cadeau unique pour ses collaborateurs, ses partenaires ou encore ses clients
              </li>
              <li>
                La possibilité d'organiser avec son équipe une
                {' '}
                <strong>visite de la ruche</strong>
                {' '}
sous la fameuse tenue d'apiculteur
          ...
          <div className="col-lg-5 col-md-6 col-sm-10 card" style={{ backgroundColor: '#ECEFF1' }}>
            ...
            <ul>
              <li>
C’est l’assurance de maintenir notre
              cheptel et de l’accroitre
              </li>
              <li>
Un nombre plus important de ruches
              nous permet plus facilement
              d’équilibrer les colonies entre elles
              </li>
              <li>
L’implantation de nouveaux ruchers
              ...
              <li>
Un moyen de sensibiliser un grand
