...
Cela représente plus de
            {this.state.qty * 50000}
            {' '}
abeilles supplémentaires pour prendre soin de la biodiversité
          </li>
          <li>
En échange nous recevons le fruit de nos abeilles:
            {this.state.pots}
            {' '}
pots de miel au design entièrement personnalisable
          </li>
        </ul>
      </div>
    );
