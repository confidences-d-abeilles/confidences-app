          ...
          <div className="col-lg-11 col-md-10 col-sm-12">
            ...
            <div className="row justify-content-center">
              <div className="col-lg-6 col-md-10 col-sm-12">
                ...
                <ViewAddress data={this.state.billing_address} company />
...
Adresse de livraison différente
                  <input type="checkbox" name="different" checked={this.state.different} onChange={this.changeAddress.bind(this)} />
                </h3>
                ...
                {this.state.paytype === '2'
                  ...
                  <div>
                    <p>
                      ...
                      fonctionnalités sont quelque peu bridées et
                      {' '}
                      <strong>
votre page dédiée ne peut être
                      publiquement consultée.
                      </strong>
                      <br />
                      <br />
                    N’oubliez pas que pour un parrainage effectué entre :
                      <ul>
                        <li>
Le 1er juillet et le 31 décembre, vous recevez le miel de vos abeilles à partir du
                      mois de mai de l’année suivante.
                        </li>
                        <li>
Le 1er janvier et le 30 juin, vous recevez le miel de vos abeilles à partir du mois
                      d’octobre.
                        </li>
                      </ul>
