      ...
      <div>
        ...
        {(!this.state.loading) ? (
          ...
          <div className="container-fluid">
            <div className="row">
              <div style={{
                width: '100%', backgroundColor: 'red', color: 'white', fontFamily: 'HighTo', fontWeight: 'bold', padding: '1em', textAlign: 'center',
              }}
              >
          ...
          <div className="container-fluid">
            <div className="row">
              <div style={{
                width: '100%', backgroundColor: '#E49C00', color: 'white', fontFamily: 'HighTo', fontWeight: 'bold', padding: '1em', textAlign: 'center',
              }}
              >
            ...
            <div className="container">
              ...
              <div className="row justify-content-center">
                <h1 style={{
                  backgroundColor: '#E49C00', fontFamily: 'HighTo', color: 'white', padding: '0.4em 2.5em', zIndex: '5',
                }}
                >
                  <small>{(this.state.user) ? this.state.user.company_name.toUpperCase() : null}</small>
                </h1>
                <div
                  className="col-lg-12"
                  style={{
                    marginTop: '-5.3em', backgroundPosition: 'center', height: '20em', backgroundImage: `url(${(this.state.cover) ? `${config.cdn_url}/${this.state.cover}` : ''})`, backgroundSize: 'cover',
                  }}
                />
              </div>
            </div>
            ...
            <div className="container" style={{ fontFamily: 'HighTo', color: '#666666', fontSize: '1.25em' }}>
                ...
                <div className="col-lg-8 px-4">
                  <div className="row">
                    <div className="col-lg-6 px-4" style={{ textAlign: 'justify' }}>
                      ...
                      <div style={{ width: '100%', height: '2px', backgroundColor: '#E49C00' }} className="mb-4" />
                      <p>
              ...
              <div className="row justify-content-end align-items-center mb-4">
                <div className="col-lg-12">
                  ...
                  <div style={{ width: '100%', height: '1px', backgroundColor: '#E49C00' }} className="mb-4" />
                  {this.state.user && this.state.news.map(actu => (
                    <div className="my-2 row">
                      ...
                      <div className="actu-second-block col-lg-8">
                        <h3 className="actu-title">
                          {actu.title}
                          <small className="actu-date">{moment(actu.date).format('DD.MM.YYYY')}</small>
                        </h3>
                        <div style={{ width: '100%', height: '1px', backgroundColor: '#E49C00' }} className="mb-4" />
