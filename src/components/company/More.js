		...
		return (
			<div className="container">
				...
				<div className="row justify-content-center">
					...
					<div className="col-9">
						<h2 className="text-center my-5">Notre proposition pour les entreprises</h2>
						<p>
...
que vous avez parrainées. Ces pots sont personnalisables avec les couleurs de votre
entreprise.<br/><br/>
Un tel parrainage s’inscrit complètement dans la démarche de « Responsabilité Sociétale
...
Savoie. Bien entendu nous vous accueillerons volontiers pour vous faire découvrir vos
abeilles. Vous souhaitiez voir vos ruches installées sur le site de votre entreprise, sur son
toit pas exemple ? N’hésitez pas à nous en faire la demande. Nous étudierons la faisabilité
du projet et nous reviendrons vers vous avec un devis si cela est envisageable (les tarifs
présents sur le site ne concernent pas cette prestation).<br/><br/>
							<Link to="/prices#company">Consulter les tarifs</Link><br/><br/>
								Ces tarifs comprennent l’envoi d’un certificat de parrainage, la création d’une page sur
	notre site internet entièrement dédiée à votre entreprise (voir ci-dessous) ; vous aurez la
...
pourquoi nous vous proposons de communiquer dessus de deux manières.
							<ul>
								<li>Une page de notre site sera entièrement dédiée à votre entreprise. Elle
comportera votre identité visuelle, une présentation de votre entreprise, une
présentation de votre action en faveur des abeilles et de l’environnement ainsi
que des photos et actualités de vos ruches. Les textes de présentation sont du
ressort de l’entreprise ; de notre côté nous alimenterons régulièrement la page en
photos et actualités.</li>
								<li>Les réseaux sociaux sur lesquels nous sommes très présents seront régulièrement
utilisés pour communiquer sur les ruches parrainées par les entreprises. Pas
moins de 15.000 followers nous suivent sur Instagram, Twitter, Facebook et
LinkedIn.</li>
							</ul>
						</p>
