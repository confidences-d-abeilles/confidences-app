				...
				<div className="row justify-content-center">
					...
					<div className="col-9">
						...
						<p>
							...
							Dépasser ses préoccupations économiques, légales et adopter un comportement plus éthique ? <br /><br />
						...
						<p>
							...
							<strong> Faites donc le choix de parrainer des ruches ! </strong><br />
							...
							plutôt qu’importé et bien souvent frelaté.<br />
						...
						<p>
							...
							l’éthique et à la responsabilité des entreprises. <br />
							Parrainer des ruches n’est pas LA solution miracle à vos problématiques de développement
							durable et de comportement responsable, mais un élément de réponse. <strong>« Les petits
							ruisseaux font les grandes rivières. »</strong><br /><br />
							<strong>Plus concrètement.</strong> Votre parrainage peut être un réel atout dans votre communication
						...
						<p>
							<strong>De la Visibilité</strong><br />
							...
							<ul>
								<li>
									<strong>La plateforme web de parrainage</strong><br />
						...
						<p>
							...
							du projet et nous reviendrons vers vous avec un devis si cela est envisageable (<i>les tarifs
							présents sur le site ne concernent pas cette prestation</i>).
						</p>
						...
						<p>
							...
							<br/><br/>
								<ul>
									<li>
										Activité Team Building (1/2 journée)<br /><br />
										...
										Pour le plus grand plaisir de vos papilles une dégustation des produits de la ruche couronne le tout.<br /><br />
									</li>
									<li>
										Séminaire Team Building (journée)<br /><br />
