    ...
    if (this.state.user && this.state.user.bundles[0] && this.state.user.bundles[0].state === 0) {
      return (
        <p className="alert alert-danger mt-4">
          ...
          <Link to="/company/payment">Cliquez ici</Link>
          {' '}
pour le faire ou
          <Link to="/company/checkout">sur ce lien</Link>
&nbsp;
          ...
          et confirmez
          <Link to="/company/payment">ici</Link>
.
...
Vous êtes inscrit(e) à la newsletter. Une fois tous les 2 mois vous recevrez des nouvelles de vos abeilles ainsi que des nôtres. Si vous ne souhaitez pas la recevoir, merci de modifier
          <Link to="/company/account">vos préférences.</Link>
        </p>
      );
    }
...
&nbsp;&nbsp;Notre parrainage
              ...
              <li className="list-group-item">
                <Link to="/company/manage/customize">
                  <FontAwesome name="flask" fixedWidth />
&nbsp;&nbsp;Nos pots de miel
                </Link>
              </li>
              <li className="list-group-item">
                <Link to="/company/manage/mypage">
                  <FontAwesome name="bookmark" fixedWidth />
&nbsp;&nbsp;Notre page dediee
                </Link>
              </li>
              <li className="list-group-item">
                <Link to="/company/manage/infos">
                  <FontAwesome name="address-card" fixedWidth />
&nbsp;&nbsp;Mes informations
                </Link>
              </li>
              <li className="list-group-item">
                <Link to="/company/manage/bills">
                  <FontAwesome name="file" fixedWidth />
&nbsp;&nbsp;Factures
                </Link>
              </li>
              <li className="list-group-item">
                <Link to="/company/manage/account">
